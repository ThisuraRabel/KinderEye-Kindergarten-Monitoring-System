...
$folder_path = "../images/letters/reading/5/";
$folder_path2 = "../images/letters/reading/5/word";
...
if ($_FILES["image1"]["error"] == UPLOAD_ERR_OK) {
  ...
  $destination = "../images/letters/reading/5/word/" . "img.jpg";
...
if ($_FILES["image2"]["error"] == UPLOAD_ERR_OK) {
  ...
  $destination = "../images/letters/reading/5/" . "img1.png";
...
if ($_FILES["image3"]["error"] == UPLOAD_ERR_OK) {
  ...
  $destination = "../images/letters/reading/5/" . "img2.png";
...
if ($_FILES["image4"]["error"] == UPLOAD_ERR_OK) {
  ...
  $destination = "../images/letters/reading/5/" . "img3.png";
