...
$folder_path = "../images/letters/reading/4/";
$folder_path2 = "../images/letters/reading/4/word";
...
if ($_FILES["image1"]["error"] == UPLOAD_ERR_OK) {
  ...
  $destination = "../images/letters/reading/4/word/" . "img.jpg";
...
if ($_FILES["image2"]["error"] == UPLOAD_ERR_OK) {
  ...
  $destination = "../images/letters/reading/4/" . "img1.png";
...
if ($_FILES["image3"]["error"] == UPLOAD_ERR_OK) {
  ...
  $destination = "../images/letters/reading/4/" . "img2.png";
...
if ($_FILES["image4"]["error"] == UPLOAD_ERR_OK) {
  ...
  $destination = "../images/letters/reading/4/" . "img3.png";
